...
<div class="container content dash">
    <div class="row">
        ...
        <ul class="list-group">
                    ...
                    <li class="list-group-item"><a data-toggle="modal" href="#profileModal">My Profile</a></li>
                    <li class="list-group-item"><a class="logoutBtn" href="#">Logout</a></li>
                </ul>
        </div>
        <div class="col-md-8 tab-content" style="position:relative; height:70vh; overflow-y:auto; border:1px solid rgba(0,0,0,0.2); border-radius:5px;">
        <div class="tab-pane fade in active" id="adoptionsMenu">
        <table class="table table-responsive table-hover table-bordered">
                        <tbody>
                        <tr>
                            <th>id</th>
                            <th>Child</th>
                            <!-- <th>Department Worker</th> -->
                            <th>Remarks</th>
                            <th>Status</th>
                            <th>Options</th>
                        </tr>
        ...
        <div class="tab-pane fade" id="childMenu">
...
<div id="profileModal" class="modal fade" role="dialog">
	...
	<option value="ZWE">Zimbabwe</option>
				...
				<br>
			<Button type="submit" class="continue btn btn-default">Save <span class="fa fa-angle-right"></span></Button>
		</form>
		<form class="changePasswordAdopter" id="changePasswordAdopter">
                ...
                <form class="changeImageAdopter" id="changeImageAdopter" method="post" enctype="multipart/form-data">
                    <h3>Change Image</h3>
